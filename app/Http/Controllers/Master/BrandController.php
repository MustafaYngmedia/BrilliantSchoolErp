...
{
    private $main_heading = "Brand ";
    private $table = 'App\Brand';
    private $view_list = "admin.brand.list";
    private $list_url = "admin.brand.list";
    private $view_form = "admin.brand.add";
    private $add_url = "admin.brand.add";
    private $delete_url = "admin.brand.delete";
    private $message_save = "Brand Updated !!";
    private $message_delete = "Brand Deleted !!";
