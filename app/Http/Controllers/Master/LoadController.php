...
{
    private $main_heading = "Load ";
    private $table = 'App\Load';
    private $view_list = "admin.load.list";
    private $list_url = "admin.load.list";
    private $view_form = "admin.load.add";
    private $add_url = "admin.load.add";
    private $delete_url = "admin.load.delete";
    private $message_save = "Load Updated !!";
    private $message_delete = "Load Deleted !!";
